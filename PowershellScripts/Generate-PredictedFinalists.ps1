...
# Output file paths:
[string] $predictedFinalLogTableWithPositionsFilePath = "FL:\DataByRound\Round$upcomingRound\Forecasts\$forecastingModel\PredictedFinalLogTable_WithPositions_$($forecastingModel).csv"
[string] $predictedFinalistsForecastFilePath = "FL:\DataByRound\Round$upcomingRound\Forecasts\$forecastingModel\PredictedFinalists_$($forecastingModel).csv"
...
# Export results:
$predictedFinalLogTableWithPositions | export-csv $predictedFinalLogTableWithPositionsFilePath -noTypeInformation
$predictedFinalists | export-csv $predictedFinalistsForecastFilePath -noTypeInformation     # For updating the fixtures
